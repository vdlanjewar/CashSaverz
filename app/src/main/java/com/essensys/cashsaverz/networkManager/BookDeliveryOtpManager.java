...
public class BookDeliveryOtpManager implements retrofit2.Callback<ResponseBody> {

    private Context mContext;
    private StatusListener listener;
    private ProgressDialog progressDialog;
    public BookDeliveryOtpManager(Context mContext, StatusListener listener) {
    ...
    public void deliverBook(String rentedBookId, String otp) {
        showLoader();
        RetrofitClient
                .getClient(Constant.ServerEndpoint.DELIVER_BOOK)
                .create(RetrofitInterfaces.DeliverBook.class)
                .post(App.getCurrentUser(mContext).getUserAuth(),App.getCurrentUser(mContext).getCustomerId(),rentedBookId, otp)
                .enqueue(this);
    }
