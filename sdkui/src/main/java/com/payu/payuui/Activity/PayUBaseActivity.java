 ...
 */
public class PayUBaseActivity extends FragmentActivity implements PaymentRelatedDetailsListener,
        ValueAddedServiceApiListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (mPaymentParams != null && mPayUHashes != null && payuConfig != null) {
                ...
                merchantWebService.setVar1(mPaymentParams.getUserCredentials() == null ? "default"
                        : mPaymentParams.getUserCredentials());
...
//                 close the progress bar
            ...
            Toast.makeText(this, getString(R.string.could_not_receive_data),
